// Ícone padrão por módulo — usado como fallback sempre que o dono do app ainda
// não configurou um ícone próprio (ModuleSettingsModal). Nunca sobrescreve o
// valor salvo, só evita telas sem nenhum ícone antes da primeira configuração.
